...
std::tuple<std::string_view, bool> parsed_tag::parse_attr(std::string_view s, int nattr, bool internal)
{
    auto q = s;
    if (q.empty() || q[0] == '>')
    {
...
std::string_view parsed_tag::parse(std::string_view s, bool internal)
{
