...
public:
    ...
    BufferPtr CreateBuffer(const URL &url, std::string_view title, CharacterEncodingScheme charset, TextLineList *list)
    {
...
private:
    ...
    ///
    void BufferFromLines(BufferPtr buf, TextLineList *list)
    {
