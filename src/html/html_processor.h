...
Str process_img(struct parsed_tag *tag, int width, class HtmlContext *seq);
Str process_anchor(struct parsed_tag *tag, char *tagbuf, class HtmlContext *seq);
Str process_input(struct parsed_tag *tag, class HtmlContext *seq);
